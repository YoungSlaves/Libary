if not game:IsLoaded() then
	repeat
		wait()
		warn("Game should be loaded for Von Lib to work successfully.")
	until game:IsLoaded()
end

--Folder Creation
if not isfolder("Von") then
	makefolder("Von")
end

if not isfolder("Von/Settings") then
	makefolder("Von/Settings")
end

if not isfolder("Von/Assets") then
	makefolder("Von/Assets")
end
...
local VonConfigName = ""
local VonConfigSettings = VonLib["Settings"]
...
local VonNotifications = Instance.new("ScreenGui")
...
function VonLib:Window(Win)
		...
		Von.Parent = LibParent

		Main.Name = "Main"
		Main.Parent = Von
		Main.BackgroundColor3 = VonLib.Themes[Theme].Main
		...
		TitleBar.BackgroundColor3 = VonLib.Themes[Theme].TitleBar
		...
		BarFixer.BackgroundColor3 = VonLib.Themes[Theme].TitleBar
		BarFixer.BorderColor3 = VonLib.Themes[Theme].TitleBar
		...
		Line.BackgroundColor3 = VonLib.Themes[Theme].TitleLineColor
		...
		Close.Text = "X"
		Close.TextColor3 = VonLib.Themes[Theme].CloseMinimize
		Close.TextSize = 18.000
		Close.Visible = false

		Line_2.Name = "Line"
		Line_2.Parent = TitleBar
		Line_2.BackgroundColor3 = VonLib.Themes[Theme].TitleLineColor
		...
		Minimize.Text = "-"
		Minimize.TextColor3 = VonLib.Themes[Theme].CloseMinimize
		...
		Title.TextColor3 = VonLib.Themes[Theme].TitleTextColor
		...
		Tabs.Parent = Main
		Tabs.Active = true
		Tabs.BackgroundColor3 = VonLib.Themes[Theme].Tabs
		...
		Shadow.ImageColor3 = VonLib.Themes[Theme].Shadow
		Shadow.ScaleType = Enum.ScaleType.Slice
		Shadow.SliceCenter = Rect.new(24, 24, 276, 276)

		local Sayfalar = {}

		function VonLib:ToggleUI()
			if Von.Enabled == true then
				Von.Enabled = false
			else
				Von.Enabled = true
			end
				...
				if visibility == true then
					...
					if openbutton ~= nil then
						if openbutton == true then
							...
							OpenFrame.Parent = Von
							OpenFrame.Active = true
							OpenFrame.BackgroundColor3 = VonLib.Themes[Theme].OpenFrame
							...
							Open.BackgroundColor3 = VonLib.Themes[Theme].Open
		...
		function Sayfalar:Tab(TabName, PageTitle)
			...
			TabBtnFrame.BackgroundColor3 = VonLib.Themes[Theme].TabBefore
			...
			Selected.BackgroundColor3 = VonLib.Themes[Theme].Selection
			Selected.BackgroundTransparency = 1
			Selected.BorderColor3 = VonLib.Themes[Theme].Selection
			...
			TabText.TextColor3 = VonLib.Themes[Theme].TabTextColor
			...
			TabButton.TextColor3 = VonLib.Themes[Theme].TabTextColor
			...
			PageTitle.TextColor3 = VonLib.Themes[Theme].PageTitleColor
			...
			if FirstTab == false then
				...
				TabBtnFrame.BackgroundColor3 = VonLib.Themes[Theme].TabAfter
				TabBtnFrame.BorderColor3 = VonLib.Themes[Theme].TabAfter
				Page.Visible = true
			end
				...
				function()
					if Page.Visible ~= true then
						...
						for i, v in pairs(Tabs:GetChildren()) do
							if v:IsA("Frame") then
								TweenService:Create(
									...
									{BackgroundColor3 = VonLib.Themes[Theme].TabBefore}
								):Play()
								TweenService:Create(
									v.Selected,
									TweenInfo.new(.2, Enum.EasingStyle.Quad),
						...
						TweenService:Create(
							TabBtnFrame,
							TweenInfo.new(.2, Enum.EasingStyle.Quad),
							{BackgroundColor3 = VonLib.Themes[Theme].TabAfter}
						):Play()
						TweenService:Create(
							Selected,
							TweenInfo.new(.2, Enum.EasingStyle.Quad),
			...
			local datas = false
			function VonLib:NewConfig(ConfigName)
				VonConfigName = ConfigName
			end

			function VonLib:SaveConfig()
				local savedfilename = "Von/Settings/" .. VonConfigName .. "Settings.json"
				local save = HttpService:JSONEncode(VonConfigSettings)
				writefile(savedfilename, save)
			end

			-- LoadConfig fonksiyonundan hemen sonra (satır ~3030)
			function VonLib:LoadConfig(ConfigName)
				LoadVonConfig = "enabled"
				if not isfile("Von/Settings/" .. ConfigName .. "Settings.json") then
					warn("Config file not found!")
					return false
				end

				local savedfile = readfile("Von/Settings/" .. ConfigName .. "Settings.json")
				datas = HttpService:JSONDecode(savedfile)

				-- Toggle
				for i, v in pairs(datas.Toggle) do
					for a, b in next, v do
						if VonLib.Elements.Toggle[a] then
							VonLib.Elements.Toggle[a]:UpdateToggle(b.Status)
						end
					end
				end
				...
				for i, v in pairs(datas.Slider) do
					for a, b in next, v do
						if VonLib.Elements.Slider[a] then
							VonLib.Elements.Slider[a]:SetValue(b.Value)
						end
					end
				end
				...
				for i, v in pairs(datas.CheckBox) do
					for a, b in next, v do
						if VonLib.Elements.CheckBox[a] then
							VonLib.Elements.CheckBox[a]:UpdateCheckBox(b.Status)
						end
					end
				end
				...
				for i, v in pairs(datas.ColorPicker) do
					for a, b in next, v do
						if VonLib.Elements.ColorPicker[a] then
							if b.Color ~= nil then
								...
								if r and g and bl then
									...
									VonLib.Elements.ColorPicker[a]:SetColor(color)
								end
							end
						end
					end
				...
				for i, v in pairs(datas.Keybind) do
					for a, b in next, v do
						if VonLib.Elements.Keybind[a] then
							VonLib.Elements.Keybind[a]:SetKey(b.Key)
						end
					end
				end
				...
				for i, v in pairs(datas.TextBox) do
					for a, b in next, v do
						if VonLib.Elements.TextBox[a] then
							VonLib.Elements.TextBox[a]:SetText(b.Text)
						end
					end
				end
				...
				for i, v in pairs(datas.Dropdown) do
					for a, b in next, v do
						if VonLib.Elements.Dropdown[a] then
							print(a)
							VonLib.Elements.Dropdown[a]:Select(b.Selected, true)
						end
					end
				end
				...
				print("Config loaded:", VonConfigName)
				return true
			end
			...
			function ContainerItems:Section(Title)
				...
				if x ~= nil then
					...
					SectionTitle.Text = x
					SectionTitle.TextColor3 = VonLib.Themes[Theme].ItemTextColors
			...
			function ContainerItems:Label(title, description)
				...
				Label.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				Label.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				LabelListing.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				LabelListing.BackgroundTransparency = 1.000
				LabelListing.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				LabelMainText.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				LabelText.TextColor3 = VonLib.Themes[Theme].ItemTextColors
			...
			function ContainerItems:Button(yazi, description, callback)
				...
				Button.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				Button.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				ButtonTitle.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				ButtonText.TextColor3 = VonLib.Themes[Theme].ItemTextColors
				...
				ClickIcon.ImageColor3 = VonLib.Themes[Theme].ButtonClickIconColor
				...
				Button.MouseEnter:Connect(
					function()
						TweenService:Create(
							Button,
							TweenInfo.new(.2, Enum.EasingStyle.Quad),
							{BackgroundColor3 = VonLib.Themes[Theme].Hover}
						):Play()
					end
				)
				Button.MouseLeave:Connect(
					function()
						TweenService:Create(
							Button,
							TweenInfo.new(.2, Enum.EasingStyle.Quad),
							{BackgroundColor3 = VonLib.Themes[Theme].ItemColors}
						):Play()
					end
				)
			...
			function ContainerItems:Paragraph(pharagraphtitle, description)
				...
				Pharagraph.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				Pharagraph.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				PharagraphTitle.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				for i, v in pairs(desc) do
					...
					PharagraphText.TextColor3 = VonLib.Themes[Theme].ItemTextColors
			...
			function ContainerItems:Slider(Text, description, minvalue, maxvalue, callback)
				...
				table.insert(VonConfigSettings.Slider, ConfigSliderSettings)
				...
				Slider.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				...
				SliderButton.BackgroundColor3 = VonLib.Themes[Theme].SliderButtonFrameColor
				...
				InSliderFrame.BackgroundColor3 = VonLib.Themes[Theme].InSliderFrame
				...
				UIGradient2.Color =
					ColorSequence.new {
						ColorSequenceKeypoint.new(0.00, VonLib.Themes[Theme].FirstSlider.First),
						ColorSequenceKeypoint.new(1.00, VonLib.Themes[Theme].FirstSlider.Second)
					}
				...
				UIGradient_3.Color =
					ColorSequence.new {
						ColorSequenceKeypoint.new(0.00, VonLib.Themes[Theme].SecondSlider.First),
						ColorSequenceKeypoint.new(1.00, VonLib.Themes[Theme].SecondSlider.Second)
					}
				...
				Num.Text = minvalue
				Num.TextColor3 = VonLib.Themes[Theme].NumColor
				Num.TextSize = 14.000
				...
				SliderTitle.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				SliderText.TextColor3 = VonLib.Themes[Theme].ItemTextColors
				...
				VonLib.Elements.Slider[ConfigSliderTitle] = slid
				return slid
			end
			...
			function ContainerItems:Line()
				...
				Line.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
			...
			function ContainerItems:ColorPicker(text, description, preset, callback)
				...
				table.insert(VonConfigSettings.ColorPicker, ConfigColorpickerSettings)
				...
				Colorpicker.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				...
				Title.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				Description.TextColor3 = VonLib.Themes[Theme].ItemTextColors
				...
				ColorpickerFrame.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				...
				Confirm.BackgroundColor3 = VonLib.Themes[Theme].TitleBar
				...
				Confirm.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				RainbowToggle.BackgroundColor3 = VonLib.Themes[Theme].TitleBar
				...
				RainbowTitle.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				RainbowToggleFrame.BackgroundColor3 = VonLib.Themes[Theme].Main
				...
				Hue.InputEnded:Connect(
					function(input)
						...
						if not LibParent:FindFirstChild("Von") then
							if HueInput then
								HueInput:Disconnect()
							end
						end
				...
				VonLib.Elements.ColorPicker[ConfigColorpickerTitle] = colory
			...
			function ContainerItems:KeyBind(title, description, first, callback)
				...
				table.insert(VonConfigSettings.Keybind, ConfigKeybindSettings)
				...
				KeyBind.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				KeyBind.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				KeyBindTitle.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				KeyBindTitle.TextSize = 15.000
				KeyBindTitle.TextXAlignment = Enum.TextXAlignment.Left

				BindSelection.Name = "BindSelection"
				BindSelection.Parent = KeyBind
				BindSelection.BackgroundColor3 = VonLib.Themes[Theme].ItemTextBoxKeyBindColors
				BindSelection.BorderColor3 = VonLib.Themes[Theme].ItemTextBoxKeyBindColors
				...
				UIStroke_9.Color = VonLib.Themes[Theme].ItemTextBoxKeyBindStrokeColors
				...
				Bind.Text = first
				Bind.TextColor3 = VonLib.Themes[Theme].ItemKeyBindTextColor
				...
				KeyBindText.TextColor3 = VonLib.Themes[Theme].ItemTextColors
				...
				VonLib.Elements.Keybind[ConfigKeybindTitle] = keybnid
			...
			function ContainerItems:Toggle(TexT, desc, check, callback)
				...
				table.insert(VonConfigSettings.Toggle, ConfigToggleSettings)
				...
				Toggle.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				...
				ToggleText.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				ToggleText.TextSize = 15.000
				ToggleText.TextXAlignment = Enum.TextXAlignment.Left

				ToggleFrame.Name = "ToggleFrame"
				ToggleFrame.Parent = Toggle
				ToggleFrame.BackgroundColor3 = VonLib.Themes[Theme].ToggleFrameColor
				...
				UIGradient_3.Color =
					ColorSequence.new {
						ColorSequenceKeypoint.new(0.00, VonLib.Themes[Theme].SlidingTogglePrimer),
						ColorSequenceKeypoint.new(1.00, VonLib.Themes[Theme].SlidingToggleSeconder)
					}
				UIGradient_3.Rotation = 90
				...
				TextboxText_2.TextColor3 = VonLib.Themes[Theme].ItemTextColors
				...
				ToggleClick.MouseButton1Click:Connect(
					function()
						if toggled == false then
							UIGradient_3.Color =
								ColorSequence.new {
									ColorSequenceKeypoint.new(0.00, VonLib.Themes[Theme].SlidingToggleToggledPrimer),
									ColorSequenceKeypoint.new(1.00, VonLib.Themes[Theme].SlidingToggleToggledSeconder)
								}
							TweenService:Create(
								SlidingToggle,
								TweenInfo.new(.2, Enum.EasingStyle.Quad),
							...
							TweenService:Create(
								ToggleFrame,
								TweenInfo.new(.2, Enum.EasingStyle.Quad),
								{BackgroundColor3 = VonLib.Themes[Theme].ToggledFrameColor}
							):Play()
							toggled = true
						else
							UIGradient_3.Color =
							...
							TweenService:Create(
								ToggleFrame,
								TweenInfo.new(.2, Enum.EasingStyle.Quad),
								{BackgroundColor3 = VonLib.Themes[Theme].ToggleFrameColor}
							):Play()
							toggled = false
						end
				...
				VonLib.Elements.Toggle[ConfigToggleTitle] = Toggleee
			...
			function ContainerItems:CheckBox(TexT, check, callback)
				...
				table.insert(VonConfigSettings.CheckBox, ConfigCheckboxSettings)
				...
				ToggleFrame.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				ToggleFrame.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				Toggle.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				ToggleText.Name = "ToggleText"
				ToggleText.Parent = Toggle
				ToggleText.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				ToggleText.BackgroundTransparency = 1.000
				ToggleText.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				ToggleIconer.BackgroundColor3 = VonLib.Themes[Theme].ItemTextBoxKeyBindColors
				ToggleIconer.BorderColor3 = VonLib.Themes[Theme].ItemTextBoxKeyBindColors
				...
				UIStroke.Color = VonLib.Themes[Theme].ItemTextBoxKeyBindStrokeColors
				UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border

				done.Name = "done"
				done.Parent = ToggleIconer
				done.BackgroundColor3 = VonLib.Themes[Theme].ItemTextBoxKeyBindColors
				done.BorderColor3 = VonLib.Themes[Theme].ItemTextBoxKeyBindColors
				...
				done.ImageColor3 = VonLib.Themes[Theme].ToggleTickColor
				...
				VonLib.Elements.CheckBox[ConfigCheckboxTitle] = Toggleee
			...
			function ContainerItems:TextBox(anan)
				...
				table.insert(VonConfigSettings.TextBox, ConfigTextboxSettings)
				...
				TextBox.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				...
				TexttingBox.BackgroundColor3 = VonLib.Themes[Theme].ItemTextBoxKeyBindColors
				...
				TexttingBox.Text = ""
				TexttingBox.TextColor3 = VonLib.Themes[Theme].ItemTextBoxTextColor
				...
				TextBoxTitle.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				TextboxText.TextColor3 = VonLib.Themes[Theme].ItemTextColors
				...
				VonLib.Elements.TextBox[ConfigTextboxTitle] = checkboxxx
			...
			function ContainerItems:Dropdown(dropz)
				...
				table.insert(VonConfigSettings.Dropdown, ConfigDropdownSettings)
				...
				Dropdown.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				...
				DropdownTitle.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				DropdownDescription.TextColor3 = VonLib.Themes[Theme].ItemTextColors
				...
				Plus.Text = "+"
				Plus.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				for i, v in pairs(dropz.List) do
					...
					ItemFrame.BackgroundColor3 = VonLib.Themes[Theme].DropdownItem
					...
					UIGradient.Color =
						ColorSequence.new {
							ColorSequenceKeypoint.new(0.00, VonLib.Themes[Theme].DropdownItemFirst),
							ColorSequenceKeypoint.new(1.00, VonLib.Themes[Theme].DropdownItemSecond)
						}
					...
					local function Update(bool)
						...
						if bool == false then
							TweenService:Create(
								ItemFrame,
								TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
								{BackgroundColor3 =  VonLib.Themes[Theme].DropdownItem}
							):Play()
						...
						elseif bool == true then
							TweenService:Create(
								ItemFrame,
								TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
								{BackgroundColor3 =  VonLib.Themes[Theme].DropdownItemHover}
							):Play()
				...
				function dropfuncs:Select(Item, reset)
					...
					local tempLoadState = LoadVonConfig
					LoadVonConfig = "enabled"
					...
					LoadVonConfig = tempLoadState
				end

				VonLib.Elements.Dropdown[ConfigDropdownTitle] = dropfuncs
			...
			function ContainerItems:Image(ImageData)
				...
				Image.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				Image.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				ImageTitle.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				ImageTitle.BackgroundTransparency = 1.000
				ImageTitle.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				ImageTitle.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				ImageTitle.TextSize = 15.000
				ImageTitle.TextXAlignment = Enum.TextXAlignment.Left

				ImageButton.Name = "ImageButton"
				ImageButton.Parent = Image
				ImageButton.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				ImageButton.BackgroundTransparency = 1.000
				ImageButton.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				Arrow.Name = "Arrow"
				Arrow.Parent = Image
				Arrow.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				Arrow.BackgroundTransparency = 1.000
				Arrow.Position = UDim2.new(0.913561523, 0, 0.211111104, 0)
				Arrow.Size = UDim2.new(0, 26, 0, 27)
				Arrow.Image = "rbxassetid://6034818372"
				Arrow.ImageColor3 = VonLib.Themes[Theme].ItemTitleColors

				ImageFrame.Name = "ImageFrame"
				ImageFrame.Parent = Container
				ImageFrame.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				ImageFrame.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				if imagetype == "Image" then
					if string.find(imagelink, "rbxassetid") then
						...
						ImageLabel.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
						ImageLabel.BackgroundTransparency = 1.000
						ImageLabel.BorderColor3 = VonLib.Themes[Theme].ItemColors
						ImageLabel.BorderSizePixel = 0
				...
				elseif imagetype == "Video" then
					if string.find(imagelink, "https") then
						...
						VideoLabel.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
						VideoLabel.BackgroundTransparency = 1.000
						VideoLabel.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				ImageListing.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				ImageListing.BackgroundTransparency = 1.000
				ImageListing.BorderColor3 = VonLib.Themes[Theme].ItemColors
				...
				ButtonTitle.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				ButtonTitle.BackgroundTransparency = 1.000
				ButtonTitle.BorderColor3 = VonLib.Themes[Theme].ItemColors
				ButtonTitle.BorderSizePixel = 0
				ButtonTitle.Size = UDim2.new(0, 379, 0, 17)
				ButtonTitle.Font = Enum.Font.GothamBold
				...
				for i, v in next, description do
					...
					ButtonText.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
					ButtonText.BackgroundTransparency = 1.000
					ButtonText.BorderColor3 = VonLib.Themes[Theme].ItemColors
					ButtonText.BorderSizePixel = 0
					ButtonText.Position = UDim2.new(0, 0, 0.170000002, 0)
					ButtonText.Size = UDim2.new(0, 379, 0, 17)
					ButtonText.Font = Enum.Font.Gotham
			...
			function ContainerItems:Video(anan)
				...
				Video.BackgroundColor3 = VonLib.Themes[Theme].ItemColors
				...
				VideoTitle.TextColor3 = VonLib.Themes[Theme].ItemTitleColors
				...
				VideoDescription.TextColor3 = VonLib.Themes[Theme].ItemTextColors
...
function VonLib:AddNotifications()
		for i, v in pairs(LibParent:GetChildren()) do
			if v.Name == "VonNotifications" then
				v:Destroy()
			end
		end
		...
		VonNotifications.Name = "VonNotifications"
		VonNotifications.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
		VonNotifications.ResetOnSpawn = false
		VonNotifications.Parent = LibParent

		NotificationListing.Name = "NotificationListing"
		NotificationListing.Parent = VonNotifications
		...
		NotifyListing.Parent = VonNotifications
